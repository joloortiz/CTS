...
function validate(form) {
  ...
  if(passconf == "") {
	inlineMsg('passconf','You must re-enter your password.',2);
	return false;
  }
  if(password != passconf) {
	inlineMsg('passconf', 'Passwords doesn\'t match. Please re-enter your password',2);
	return false;
  }
  if(email == "") {
  ...
  if(!mobilenumber.match(numRegex)) {
